        ...
        <>
            ...
            <header className="absolute inset-x-0 top-0 z-50">
                ...
                <div className="flex lg:flex-1">
                    ...
                    <img className="h-14 w-auto" src={eddy} alt="eddy the mascot (My icon)"></img>
                    </Link>
                </div>
                ...
                <div className="hidden lg:flex lg:gap-x-12">
                    <Link to='/aboutme' className="text-sm font-semibold leading-6 text-gray-900">About Me</Link>
                    <Link to='/projects'className="text-sm font-semibold leading-6 text-gray-900">Projects</Link>
                    <Link to='/travels' className="text-sm font-semibold leading-6 text-gray-900">Travels</Link>
                    <Link to='/blogs' className="text-sm font-semibold leading-6 text-gray-900">Blogs</Link>
                </div>
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    <a href="#" className="text-sm font-semibold leading-6 text-gray-900">Contact Me <span aria-hidden="true">&rarr;</span></a>
                </div>
                </nav>
